// Improved deployment script for DeFiAid contracts
// Deploys AdminRegistry first, then CampaignFactory
const hre = require("hardhat");
require("dotenv").config();

async function main() {
  console.log("Starting improved deployment process...");
  ...
  const deploymentPath = `./deployments/${network}-improved.json`;
  ...
  try {
    ...
    if (network === "sepolia") {
      envVars.NEXT_PUBLIC_ADMIN_REGISTRY_ADDRESS_SEPOLIA = adminRegistryAddress;
      envVars.NEXT_PUBLIC_CAMPAIGN_FACTORY_ADDRESS_SEPOLIA = campaignFactoryAddress;
    } else if (network === "mainnet") {
      envVars.NEXT_PUBLIC_ADMIN_REGISTRY_ADDRESS_MAINNET = adminRegistryAddress;
      envVars.NEXT_PUBLIC_CAMPAIGN_FACTORY_ADDRESS_MAINNET = campaignFactoryAddress;
    }
